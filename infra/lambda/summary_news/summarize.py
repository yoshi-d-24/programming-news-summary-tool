...
def run(content: str):
    ...
    content = '''Yahoo!ニュース（ヤフーニュース）は、日本の企業LINEヤフー[注 1]が運営するポータルサイト『Yahoo! JAPAN』のニュースサイト。日本国内や海外のニュース・話題を多岐にわたり提供するウェブサイトである。1996年7月サービス開始[1]。iOS・Androidスマートフォン用の専用アプリ「Yahoo!ニュースアプリ」もある[2][3]。
